...
label, h2 {
	...
	<body>
		...
		<div class="topnav" id="myTopnav">
			...
			<a href='cadProf.php' class='active'>Cadastrar professor</a>
...
<form action="cad_prof.php" method="POST">
  ...
  <div class="row">
	...
	<div class="form-group col-md-2">
      ...
      <input type="password" class="form-control" name="senha"  placeholder="Digite uma senha aqui" required>
    </div>
  ...
  <div id="actions" class="row" align="right">
    <div class="col-md-12">
      ...
      <a href="busca_prof.php"><button type="button" class="btn btn-danger btn-xs"> Cancelar <img src="img/cancel_icon.png" alt="Academia" width="18"></button></a>
    </div>
  </div>
